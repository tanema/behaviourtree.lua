...
describe('BehaviourTree', function()
  ...
  describe(':run', function()
    ...
    describe('if not already started', function()
      ...
      describe('if running', function()
        ...
        it('should not call start on the current node', function()
          stub(subject.rootNode, 'start')
          subject:run()
          assert.stub(subject.rootNode.start).was_not.called()
        end)
      end)
  ...
  describe(':success', function()
    ...
    it('should set nodeRunning as false', function()
      subject.nodeRunning = true
      subject:success()
